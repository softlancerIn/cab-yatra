        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('customCities_create')}}" class="forms-sample" method="POST"
                            ...
                            <div class="row">
                                {{-- <div class="col-lg-6 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="car_category" id="car_category" class="form-control">
                                            ...
                                            <option value="{{$value->id}}">{{$value->car->name ?? ' '}}</option>
                                            @endforeach
                                        </select>
                                ...
                                {{-- <div class="col-lg-6 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fair" placeholder="Fair" name="fair">
                                        @if($errors->has('fair'))
