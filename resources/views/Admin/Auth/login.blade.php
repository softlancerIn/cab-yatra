...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{env('ASSET_ADMIN_URL')}}assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css">
    <link rel="stylesheet" href="{{env('ASSET_ADMIN_URL')}}assets/css/style.css">
    <link rel="shortcut icon" href="{{env('ASSET_ADMIN_URL')}}assets/images/favicon.png')/>
  </head>
  <body>
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                {{-- <div class="brand-logo">
                  <img src="{{env('ASSET_ADMIN_URL')}}assets/images/logo.svg')}}" alt="">
                </div> --}}
                ...
                @csrf
                    ...
                    @if($errors->has('error'))
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>{{$errors->get('error')}}</strong>
                  ...
                  <div class="mt-3 d-grid gap-2">
                    <button type="submit" class="btn btn-block btn-primary btn-sm fw-medium auth-form-btn">Sign In</button>
                  </div>
    ...
    {{-- <script src="{{env('ASSET_ADMIN_URL')}}assets/js/off-canvas.js')}}"></st>
    <script src="{{env('ASSET_ADMIN_URL')}}assets/js/template.js')}}"></st>
