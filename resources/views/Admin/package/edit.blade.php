                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="category" id="category" class="form-select form-control">
                                    <option value="" selected disabled>Select Fule Type</option>
                                    <option value="sedan" {{$data['edit']->category == 'sadan' ? 'selected' : ''}}>Sedan</option>
                                    <option value="hatchback" {{$data['edit']->category == 'hatchback' ? 'selected' : ''}}>Hatchback</option>
                                    <option value="suv" {{$data['edit']->category == 'suv' ? 'selected' : ''}}>SUV</option>
                                    <option value="coupe" {{$data['edit']->category == 'coupe' ? 'selected' : ''}}>Coupe</option>
                                    <option value="convertable" {{$data['edit']->category == 'convertable' ? 'selected' : ''}}>Convertable</option>
                                    <option value="crossover" {{$data['edit']->category == 'crossover' ? 'selected' : ''}}>Crossover</option>
                                    <option value="other" {{$data['edit']->category == 'other' ? 'selected' : ''}}>Other</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
