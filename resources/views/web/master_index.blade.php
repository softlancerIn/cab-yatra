...
@section('content')
                                        ...
                                        <div class="col-md-6 outStattionPickupCityDiv">
                                            <div
                                                ...
                                                <input type="text" class="form-control ps-1 bg-transparent border-0 "
                                                    ...
                                                    value="{{$data['footerLinkData']->pickup}}">
                                        ...
                                        <div class="col-md-6  ">
                                            <div
                                                ...
                                                <input type="text" class="form-control ps-1 bg-transparent border-0 "
                                                    ...
                                                    value="{{$data['footerLinkData']->destination}}">
                                            </div>
    ...
    <div class="container-fluid mt-3 text-center">
        <img src="{{url('public/uploads/footer_image' . '/' . $data['footerLinkData']->image)}}" alt="" style="width: 100%;
                    height: auto;
                    object-fit: cover;">
    </div>
    <div class="container-fluid mt-3">
        {!! $data['footerLinkData']->content !!}
    </div>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhTJHj8fT_dHJMkH0ndpW0guo4EQzXhHY&libraries=places"></script>
    <script>
