...
@section('content')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAsQryHkf5N7-bx_ZBMJ-X7yFMa9WTqwt0&libraries=places"></script>
    ...
    <script>
        ...
        window.onload = function () {
            ...
            // initCityAutocomplete('anotherCityInput', '#anotherHiddenField', {componentRestrictions: {country: 'us'}});
        };
    </script>
    <script>
    ...
    function hourlyPickupLoc() {
        ...
        $(document).ready(function () {
            ...
            function validateAndSubmit({ pickup, destination, phone, airportFlag, form, phoneLabel = "Phone Number", validatePhone = true }) {
